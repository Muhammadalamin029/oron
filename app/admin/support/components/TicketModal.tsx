...
import { StatusBadge, OrangeButton, AdminModal } from "@/components/admin-ui";
          ...
          <div className="p-6 space-y-5 overflow-y-auto">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="bg-[#0a0a0a] border border-[#1a1a1a] text-foreground px-4 py-2 rounded-lg text-sm focus:outline-none focus:border-primary transition-all appearance-none"
                >
                  {STATUSES.map((s) => (
                  ...
                  ticket.messages!.map((m) => (
                    <div
                      ...
                      className={`rounded-lg border border-white/5 p-4 ${
                        m.sender === "admin" ? "bg-primary/5" : "bg-[#0a0a0a]/50"
                      }`}
                    >
            ...
            <div>
              ...
              <textarea
                ...
                disabled={sending}
                rows={3}
                className="w-full bg-[#0a0a0a] border border-[#1a1a1a] text-foreground placeholder:text-border px-4 py-3 rounded-lg text-sm focus:outline-none focus:border-primary transition-all resize-none mb-3"
              />
